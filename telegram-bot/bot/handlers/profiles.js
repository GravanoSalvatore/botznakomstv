...
const SCALING_CONFIG = {
    // Настройки очереди сообщений для 1000+ пользователей
    MESSAGE_QUEUE: {
        CONCURRENCY: 50, // 🚀 УВЕЛИЧЕНО С 15 ДО 50
        INTERVAL: 1000,
        INTERVAL_CAP: 200, // 🚀 УВЕЛИЧЕНО С 60 ДО 200
        TIMEOUT: 30000,
    },
    ...
    CACHE: {
        ...
        FILTERS_TTL: 600, // 10 минут для фильтров
        SESSIONS_TTL: 1800, // 30 минут для сессий
        MAX_FILTER_KEYS: 500, // 🚀 УВЕЛИЧЕНО С 200 ДО 500
        CHECKPERIOD: 300,
    },
    ...
    PERFORMANCE: {
        ...
        MAX_CAPTION_LENGTH: 900,
        MESSAGE_TTL: 86400000,
        FILTER_CHUNK_SIZE: 500, // 🚀 УМЕНЬШЕНО ДЛЯ ОПТИМИЗАЦИИ ПАМЯТИ
        MAX_CONCURRENT_FILTERS: 10, // 🚀 УВЕЛИЧЕНО С 3 ДО 10
    }
};
// ===================== ВСПОМОГАТЕЛЬНЫЕ КОНСТАНТЫ =====================
const AGE_RANGES = [
